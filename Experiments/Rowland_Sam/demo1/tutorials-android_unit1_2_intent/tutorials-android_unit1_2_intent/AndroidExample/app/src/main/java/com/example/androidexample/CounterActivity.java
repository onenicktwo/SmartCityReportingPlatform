...
public class CounterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref = getSharedPreferences("ints", MODE_PRIVATE);
        editor = pref.edit();
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (counter > pref.getInt("high", 0)) {
                    editor.putInt("high", counter);
                    editor.apply();
                }
                if (counter < pref.getInt("low", 0)) {
                    editor.putInt("low", counter);
                    editor.apply();
                }
